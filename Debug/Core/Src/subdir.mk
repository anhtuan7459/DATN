...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/ai_linker_wrap.cyclo ./Core/Src/ai_linker_wrap.d ./Core/Src/ai_linker_wrap.o ./Core/Src/ai_linker_wrap.su ./Core/Src/ai_preprocess.cyclo ./Core/Src/ai_preprocess.d ./Core/Src/ai_preprocess.o ./Core/Src/ai_preprocess.su ./Core/Src/app_threadx.cyclo ./Core/Src/app_threadx.d ./Core/Src/app_threadx.o ./Core/Src/app_threadx.su ./Core/Src/bl0940_driver.cyclo ./Core/Src/bl0940_driver.d ./Core/Src/bl0940_driver.o ./Core/Src/bl0940_driver.su ./Core/Src/jam_ai.cyclo ./Core/Src/jam_ai.d ./Core/Src/jam_ai.o ./Core/Src/jam_ai.su ./Core/Src/jam_detect.cyclo ./Core/Src/jam_detect.d ./Core/Src/jam_detect.o ./Core/Src/jam_detect.su ./Core/Src/jam_led.cyclo ./Core/Src/jam_led.d ./Core/Src/jam_led.o ./Core/Src/jam_led.su ./Core/Src/linked_list.cyclo ./Core/Src/linked_list.d ./Core/Src/linked_list.o ./Core/Src/linked_list.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/stm32h5xx_hal_msp.cyclo ./Core/Src/stm32h5xx_hal_msp.d ./Core/Src/stm32h5xx_hal_msp.o ./Core/Src/stm32h5xx_hal_msp.su ./Core/Src/stm32h5xx_hal_timebase_tim.cyclo ./Core/Src/stm32h5xx_hal_timebase_tim.d ./Core/Src/stm32h5xx_hal_timebase_tim.o ./Core/Src/stm32h5xx_hal_timebase_tim.su ./Core/Src/stm32h5xx_it.cyclo ./Core/Src/stm32h5xx_it.d ./Core/Src/stm32h5xx_it.o ./Core/Src/stm32h5xx_it.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32h5xx.cyclo ./Core/Src/system_stm32h5xx.d ./Core/Src/system_stm32h5xx.o ./Core/Src/system_stm32h5xx.su ./Core/Src/tx_initialize_low_level.d ./Core/Src/tx_initialize_low_level.o
